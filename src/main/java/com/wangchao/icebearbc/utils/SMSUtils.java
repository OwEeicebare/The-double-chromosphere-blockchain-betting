...
public class SMSUtils {
    ...
    //替换成你的AK
    static final String accessKeyId = "LTAIfA2rteGVSbTG";//你的accessKeyId,参考本文档步骤2
    static final String accessKeySecret = "L9un0JlLa5qm22pzImQiwPF80ZIoK0";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String sendSms(String phone) throws ClientException {
        ...
        //我的模版内容为: 验证码为：${code}，5分钟内有效,打死也不要告诉别人哦!
